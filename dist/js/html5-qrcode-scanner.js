...
class Html5QrcodeScanner {
    ...
    __createSectionControlPanel() {
        ...
        scpCameraScanRegion.style.display = this.currentScanType == Html5QrcodeScanner.SCAN_TYPE_CAMERA ?
            "block" : "none";
        ...
        requestPermissionButton.classList.add('btn-success')
        ...
        fileBasedScanRegion.style.display = this.currentScanType == Html5QrcodeScanner.SCAN_TYPE_CAMERA ?
            "none" : "block";
