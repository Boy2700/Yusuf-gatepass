...
<div class="card card-outline card-success">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="<?php echo base_url."admin?page=employee/manage_employee" ?>" id="create_new" class="btn btn-flat btn-sm btn-success"><span class="fas fa-plus"></span>  Add New Employee</a>
		</div>
	</div>
	<div class="card-body">
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    ...
				                    <a class="dropdown-item" href="<?php echo base_url."admin?page=employee/manage_employee&id=".$row['id'] ?>" data-id ="<?php echo $row['id'] ?>"><span class="fa fa-edit text-success"></span> Edit</a>
				                    <div class="dropdown-divider"></div>
